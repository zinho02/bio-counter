...
%%  ----------2bits-----------
 ...
 %%  ----------3bits-----------
  ...
  dpdt = ( 1.011* pulso3(i) * ((1 + thp1 / (thkp1)) / thdiv)     /   (1 + (thii2 / (1 + thp1s(i) ) ) ^ thbeta2)   ) - thii1;
  thii1 = dpdt * dt + thii1;
  thi1s(i) = thii1; 
    
  dpdt = ( pulso3(i) * ((1 + thp1 / (thkp1)) / thdiv)       /              (1 + (thii1 / (1 + thp2s(i) ) ) ^ thgama2)     ) - thii2;
  thii2 = dpdt * dt + thii2;
  thi2s(i) = thii2; 
...
grid on;
%plot(t, p1s, 'b;P1;', t ,p2s, 'r;P2;', t , pulso , 'k;pulso;');
plot(t, thp1s, 'b;thP1;', t ,thp2s, 'r;thP2;', t , thi2s, 'y;thi2;', t ,thi1s,'g;thi1;', t , pulso , 'k;pulso;', t, pulso3, 'm;pulso3;');
xlabel('t');
ylabel('Concentration');
